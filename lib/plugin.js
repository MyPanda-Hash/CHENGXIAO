...
export const Config = {
  '~standard': {
    ...
    validate(input) {
      ...
      if (value.relayEnabled === true && value.relayUrl === undefined) {
        issues.push({
          message: 'relayUrl must name the relay when relayEnabled is true; enabling the relay with nothing to reach is a configuration error',
        });
      }
