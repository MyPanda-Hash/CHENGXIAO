 ...
 *
 * No dependencies beyond `react` and `fetch`, and no build step: the module is
 * plain CommonJS, matching how other plugins ship a client half.
 */
(function (root, factory) {
  if (typeof module === "object" && module.exports) module.exports = factory(require, module);
  else root.dshPeerMcpClient = factory(root.require, root.module);
})(typeof globalThis !== "undefined" ? globalThis : this, function (require, module) {
